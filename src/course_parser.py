    ...
    _SECTIONS = {
        "fall2026": [
            SectionDetail(
                ...
                availability=Availability(status="open", open_seats=10, max_seats=150, waitlisted=0),
                schedule=Schedule(days=["M", "W"], begin_time="13:30", end_time="14:45"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="waitlist", open_seats=0, max_seats=150, waitlisted=5),
                schedule=Schedule(days=["T", "TH"], begin_time="10:15", end_time="11:30"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="open", open_seats=5, max_seats=30, waitlisted=0),
                schedule=Schedule(days=["F"], begin_time="10:40", end_time="12:30"),
            ...
            SectionDetail(
                ...
                number="001", component="LEC",
                availability=Availability(status="open", open_seats=25, max_seats=200, waitlisted=0),
                schedule=Schedule(days=["T", "TH"], begin_time="13:30", end_time="14:45"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="open", open_seats=1, max_seats=26, waitlisted=0),
                schedule=Schedule(days=["M", "W", "F"], begin_time="08:30", end_time="09:20"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="closed", open_seats=0, max_seats=30, waitlisted=10),
                schedule=Schedule(days=["T", "TH"], begin_time="11:20", end_time="12:10"),
            ...
            SectionDetail(
                ...
                number="001", component="LEC",
                availability=Availability(status="open", open_seats=15, max_seats=40, waitlisted=0),
                schedule=Schedule(days=["M", "W", "F"], begin_time="09:35", end_time="10:25"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="open", open_seats=3, max_seats=40, waitlisted=0),
                schedule=Schedule(days=["T", "TH"], begin_time="16:30", end_time="17:45"),
        ...
        "spring2026": [
            SectionDetail(
                course_prefix="CSC", course_number="226",
                number="001", component="LEC",
                availability=Availability(status="open", open_seats=30, max_seats=200, waitlisted=0),
                schedule=Schedule(days=["M", "W", "F"], begin_time="15:00", end_time="16:15"),
            ...
            SectionDetail(
                ...
                availability=Availability(status="open", open_seats=5, max_seats=30, waitlisted=0),
                schedule=Schedule(days=["M", "W"], begin_time="09:35", end_time="10:25"),
                location="1306 Carmichael Gym", instructors=["Staff"],
            ...
            SectionDetail(
                course_prefix="MA", course_number="241",
                number="002", component="LEC",
                availability=Availability(status="waitlist", open_seats=0, max_seats=40, waitlisted=8),
                schedule=Schedule(days=["T", "TH"], begin_time="08:30", end_time="09:45"),
